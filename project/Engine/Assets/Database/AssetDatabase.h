 ...
 * - 各アセットファイル（テクスチャ、モデル等）に対応する ".meta" ファイルから GUID を取得し、
 *   一意の ID でアセットレコード（AssetRecord）をキャッシュ管理します。
 * - エディタのファイルシステム監視やマテリアル/アニメーションの自動ロード等と連携します。
 *---------------------------------------------------------------------------------------*/
/**
 * @brief AssetDatabaseの機能を提供するクラスです。
 */
class AssetDatabase {
public:
	//===================================================================*/
