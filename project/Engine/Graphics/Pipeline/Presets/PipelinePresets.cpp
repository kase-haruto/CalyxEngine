...
GraphicsPipelineDesc PipelinePresets::MakeFilmGrain() {
	GraphicsPipelineDesc desc;
	desc.VS(L"CopyImage.VS.hlsl")
		.PS(L"FilmGrain.PS.hlsl")
		.BlendNone()
		.CullNone()
		.DepthEnable(false)
		.RTV(DXGI_FORMAT_R8G8B8A8_UNORM)
...
//		DepthVisualize
/////////////////////////////////////////////////////////////////////////////////////////
GraphicsPipelineDesc PipelinePresets::MakeDepthVisualize() {
	GraphicsPipelineDesc desc;
	desc.VS(L"CopyImage.VS.hlsl")
		.PS(L"DepthVisualize.PS.hlsl")
		.BlendNone()
		.CullNone()
		.DepthEnable(false)
		.RTV(DXGI_FORMAT_R8G8B8A8_UNORM)
