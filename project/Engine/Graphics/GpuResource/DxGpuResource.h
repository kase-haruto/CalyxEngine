...
/*-----------------------------------------------------------------------------------------
 * DxGpuResource
 * - RenderTargetまたはDepthStencil用DirectX12 Resourceを所有するクラス
 * - Resource生成、各種View作成、Resource State遷移の記録を担当する
 * - Device、Command List、Descriptor Heap自体は所有しない
 *---------------------------------------------------------------------------------------*/
/**
 * @brief DxGpuResourceの機能を提供するクラスです。
 */
class DxGpuResource {
public:
	//===================================================================*/
