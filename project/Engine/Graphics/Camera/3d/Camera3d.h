...
private:
    ...
    static CxMath::Vector3 SmoothDampVec(const CxMath::Vector3& current,
                                 const CxMath::Vector3& target,
                                 CxMath::Vector3& currentVelocity,
...
private:
    ...
    struct FollowSettings {
        ...
        CxMath::Vector3 lookAtOffset    = {0.0f, 1.5f, 0.0f}; // 必要なら使用
        ...
        CxMath::Vector3 posVel = {0,0,0};                   // SmoothDamp 用速度
    } follow_;
};