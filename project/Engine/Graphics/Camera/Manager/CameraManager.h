...
public:
	...
	const CalyxMath::Vector2& ViewportSize(ViewportType) const; // const ref (cheap & safe)
	void  SetViewportSize(ViewportType, const CalyxMath::Vector2&);
	...
	static const CalyxMath::Vector2& GetViewportSizeStatic(ViewportType);
	static void SetViewportSizeStatic(ViewportType, const CalyxMath::Vector2&);
