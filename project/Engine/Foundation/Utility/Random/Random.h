...
public:
	...
	static CxMath::Vector3 GenerateVector3(float min, float max){
	...
	/// <returns></returns>
	static CxMath::Vector3 GenerateVector3(const CxMath::Vector3& min, const CxMath::Vector3& max){
