...
bool PlayerShootingController::RequestShoot(const CxMath::Vector3& pos, const CxMath::Vector3& dir){
...
void PlayerShootingController::RequestShootStraight(const CxMath::Vector3& pos, const CxMath::Vector3& dir){
	if (straightShooter_) straightShooter_->Shoot(pos, dir);
}

void PlayerShootingController::RequestShootHoming(const CxMath::Vector3& pos, const CxMath::Vector3& dir){
