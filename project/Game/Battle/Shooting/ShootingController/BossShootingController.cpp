...
//		発射Request
/////////////////////////////////////////////////////////////////////////////////////////
bool BossShootingController::RequestShoot([[maybe_unused]] const CalyxMath::Vector3& pos, [[maybe_unused]] const CalyxMath::Vector3& dir) {
	if(shootCooldown_ >= 0) {
		return false;
	}
...
//		弾の生成
/////////////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<BaseBullet> BossShootingController::AddBullet(BulletID id, const CalyxMath::Vector3& pos, const CalyxMath::Vector3& vel) {
