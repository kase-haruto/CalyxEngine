...
namespace CalyxUtil {
	...
	bool RaycastSegment(const CalyxMath::Vector3& from, const CalyxMath::Vector3& to, const std::vector<SceneObject*>& objects, RaycastHit& outHit, float startOffset) {
	...
	bool HasLineOfSight(const CalyxMath::Vector3& from, const CalyxMath::Vector3& to, const std::vector<SceneObject*>& objects, const std::function<bool(void*)>& isPlayer, float startOffset) {
		RaycastHit hit{};
